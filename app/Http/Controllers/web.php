...
use App\Http\Controllers\TransaksiSubCPMKController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Additional routes for RoleController permissions management
...
Route::post('/cplpl', [CplPlController::class, 'store'])->name('cplpl.store');
