        ...
        <div class="card-body">
            ...
            <form action="{{ route('dosen.update', $dosen->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="form-floating">
                            <input type="text" name="nama" value="{{ $dosen->nama }}" required id="namaDosen" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" name="nip" id="nipDosen" value="{{ $dosen->nip }}" class="form-control @error('nip') is-invalid @enderror">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" name="jabatan_fungsional" value="{{ $dosen->jabatan_fungsional }}" required id="jabatan" class="form-control @error('jabatan_fungsional') is-invalid @enderror" placeholder="Jabatan">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <select class="form-select @error('sertifikasi_dosen')is-invalid @enderror" name="sertifikasi_dosen" >
                                <option value="1" {{ $dosen->sertifikasi_dosen == 1 ? 'selected' : '' }} >Memiliki</option>
                                <option value="0" {{ $dosen->sertifikasi_dosen == 0 ? 'selected' : '' }} >Belum</option>
                            </select>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <textarea name="bidang_pengajaran" required id="bidangPengajaran" cols="30" rows="10" class="form-control">{{ $dosen->bidang_pengajaran }}</textarea>
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <input type="file" name="qr_sign" id="sign" class="form-control @error('qr_sign')is-invalid @enderror">
